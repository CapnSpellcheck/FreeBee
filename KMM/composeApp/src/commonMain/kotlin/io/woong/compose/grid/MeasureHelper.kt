...
/**
 * jpellico: This has been modified to fill columns first (in the case of a VerticalGrid).
...
internal class GridMeasureHelper(
    ...
    fun arrange(
        ...
        var mainAxisIndex = 0; var crossAxisIndex = 0
        placeableMeasureInfoTable.forEach { placeableLine ->
            ...
            placeableLine.forEach { placeableMeasureInfo ->
                ...
                mainAxisIndex += 1
                if (mainAxisIndex == mainAxisCount) {
                    crossAxisIndex += 1
                    mainAxisIndex = 0
                }
            }
