...
#ifndef FREEBEEDATA_SWIFT_H
#define FREEBEEDATA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FreeBeeData",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11FreeBeeData13CDEnteredWord")
@interface CDEnteredWord : NSManagedObject
- (nonnull instancetype)initWithContext:(NSManagedObjectContext * _Nonnull)context string:(NSString * _Nonnull)string;
@property (nonatomic, copy) NSString * _Nonnull value;
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end

@class NSDate;
@class CDGameProgress;
...
/// Android.
SWIFT_CLASS("_TtC11FreeBeeData6CDGame")
...
@property (nonatomic, strong) CDGameProgress * _Nonnull progress;
...
SWIFT_CLASS("_TtC11FreeBeeData14CDGameProgress")
@interface CDGameProgress : NSManagedObject
@property (nonatomic, copy) NSString * _Nonnull currentWord;
